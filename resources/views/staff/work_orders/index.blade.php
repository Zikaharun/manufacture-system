                    ...
                    @forelse ($workOrders as $index => $order)
                        <tr>
                            ...
                            <td class="px-6 py-4 flex space-x-2">
                                <a href="{{ route('staff.work_orders.edit', $order->id) }}" 
                                   class="text-yellow-600 hover:text-yellow-800">Edit</a>
                                <a href="{{ route('staff.work_orders.show', $order->id) }}" 
                                   class="text-yellow-600 hover:text-yellow-800">detail</a>
                            </td>
                        </tr>
                    @empty
                        <tr>
